package com.helion.admin.catalog.infrastructure.api.video;
...
public interface VideoAPI {
    ...
    ResponseEntity<?> createFull(
            ...
            @RequestParam(name = "thumbnail_file", required = false)MultipartFile thumbFile,
            @RequestParam(name = "thumbnail_half_file", required = false)MultipartFile thumbHalfFile
            );
    ...
    @Operation(summary = "Get video by it's identifier")
    @ApiResponses(value= {
    ...
    @GetMapping(value = "{id}/medias/{type}", produces = MediaType.APPLICATION_JSON_VALUE)
    @Operation(summary = "Get a video media by it's identifier and type")
    @ApiResponses(value= {
    ...
    @PostMapping(value = "/{id}/medias/{type}", produces = MediaType.APPLICATION_JSON_VALUE)
    @Operation(summary = "Upload a video media by it's identifier and type")
    @ApiResponses(value= {
