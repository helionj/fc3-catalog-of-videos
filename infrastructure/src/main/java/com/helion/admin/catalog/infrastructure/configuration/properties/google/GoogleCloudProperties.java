package com.helion.admin.catalog.infrastructure.configuration.properties.google;
...
public class GoogleCloudProperties implements InitializingBean {
    ...
    private static Logger log =  LoggerFactory.getLogger(GoogleCloudProperties.class);
