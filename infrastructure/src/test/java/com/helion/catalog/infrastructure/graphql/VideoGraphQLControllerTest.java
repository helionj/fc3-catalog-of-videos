...
public class VideoGraphQLControllerTest {
    ...
    private static final ParameterizedTypeReference<Set<String>> RELATIONS_TYPE = new ParameterizedTypeReference<>() {};
    ...
    @Test
    public void givenDefaultArgumentsWhenCallsVideos_shouldReturn(){
    ...
    @Test
    public void givenCustomArgumentsWhenCallsListVideos_shouldReturn(){
    ...
    @Test
    public void givenVideoInputWhenCallsSaveGenreMutation_shouldPersistAndReturn() {
        ...
        Assertions.assertEquals(expectedThumbnail, actualVideo.thumb());
        Assertions.assertEquals(expectedThumbnailHalf, actualVideo.thumbHalf());
