...
public class CreateVideoUseCaseTest extends UseCaseTest {
    ...
    protected List<Object> getMocks() {
        return List.of(videoGateway,genreGateway,categoryGateway,castMemberGateway, mediaResourceGateway);
    }

    @Test
    public void givenAnValidCommand_whenCallsCreateVideo_shouldReturnVideoID(){
    ...
    @Test
    public void givenAnValidCommandWithoutCategories_whenCallsCreateVideo_shouldReturnVideoID(){
    ...
    @Test
    public void givenAnValidCommandWithoutGenres_whenCallsCreateVideo_shouldReturnVideoID(){
    ...
    @Test
    public void givenAnValidCommandWithoutCastMembers_whenCallsCreateVideo_shouldReturnVideoID(){
    ...
    @Test
    public void givenAnValidCommandWithoutResources_whenCallsCreateVideo_shouldReturnVideoID(){
    ...
    public void givenAnInvalidRating_whenCallsCreateVideo_shouldReturnDomainException(){
        ...
        final var expectedOpened = Fixture.bool();
        final var expectedPublished = Fixture.bool();
        final String expectedRating = "INVALID_RATING";
        final var expectedCategories = Set.<CategoryID>of();
        final var expectedGenres = Set.<GenreID>of();
        final var expectedMembers = Set.<CastMemberID>of();
    ...
    @Test
    public void givenANullLaunchedYear_whenCallsCreateVideo_shouldReturnDomainException(){
    ...
    @Test
    public void givenAnValidCommandAndSomeCategoriesDoesNotExists_whenCallsCreateVideo_shouldReturnDomainException(){
    ...
    @Test
    public void givenAnValidCommandAndSomeGenresDoesNotExists_whenCallsCreateVideo_shouldReturnDomainException(){
    ...
    @Test
    public void givenAnValidCommandAndSomeCastMembersDoesNotExists_whenCallsCreateVideo_shouldReturnDomainException(){
    ...
    @Test
    public void givenAnValidCommand_whenCallsCreateVideoThrowsException_shouldCallClearResources(){
